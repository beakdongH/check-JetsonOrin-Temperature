...
# - y-axis 0..100°C
# - 창 표시 + PNG 저장
# - pandas, matplotlib 필요: pip install pandas matplotlib
# - 실행: python3 plot_jetson_temps_vs.py
# - CSV 파일 경로는 코드 상단에서 지정
...
CSV_PATH = r"./~/jtop_log/jtop_temps.csv"  # ← real path로 변경
...
def main():
    ...
    ax.set_ylim(20, 90) # y축 범위(can change if needed)
